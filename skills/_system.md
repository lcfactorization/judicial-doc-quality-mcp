...
系统会根据案号和文书内容自动推断审级：
- **案号推断**：民终/行终/刑终 → 二审；民再/行再/刑再 → 再审；民初/行初/刑初 → 一审
- **内容推断**：出现"上诉人/被上诉人" → 二审；"申诉人/被申诉人" → 再审；"原告/被告"（无上诉人） → 一审

### 评估范围界定规则

| 规则 | 说明 |
|------|------|
| **仅评当前审级** | 二审文书仅评二审法院的裁判行为，不对一审裁判质量做评判 |
| **区分责任主体** | 一审责任由一审法院承担，二审责任由二审法院承担，不可混同 |
| **审级标注** | 每个扣分项/加分项必须标注 `stage_scope`（审级归属），标明该问题属于哪个审级 |
| **跨审级问题** | 如二审未纠正一审错误，属于二审责任；如二审纠正了一审错误，则该问题属于一审 |
| **审级不明** | 如无法区分审级归属，设置 `stage_unclear=true`，在报告中标注"审级归属不明" |
| **术语适配** | 二审文书使用"上诉人/被上诉人"，一审使用"原告/被告"，不可混用 |

### 责任人界定

| 审级 | 责任主体 | 评估范围 |
|------|---------|---------|
| 一审 | 一审法院（法官/审判员） | 事实认定、法律适用、程序规范 |
| 二审 | 二审法院（审判长/承办法官） | 对一审判决的审查、自身裁判行为 |
| 再审 | 再审法院 | 对原审生效判决的审查、再审裁判 |
| 仲裁 | 仲裁机构/仲裁员 | 仲裁程序和裁决 |
| 行政 | 行政机关 | 行政决定程序和实体 |
